import { buildAvatarProxyUrl, buildSearchParams, buildSearchQuery, dedupeUsersByLogin, getNextPage, mapSearchResponse, parseRateLimit, shouldShortCircuitRateLimit } from "../src";
...
describe("rate limits", () => {
    ...
    it("detects when to short circuit on rate limit", () => {
        ...
        const info = { remaining: 0, reset: now + 120 };
